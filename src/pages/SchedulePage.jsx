  ...
  return (
    <div className="min-h-screen max-w-[100%] overflow-x-clip">
      ...
      <main className="pt-28 sm:pt-32">
        ...
        <section className="mx-auto max-w-[72rem] px-5 py-14 sm:px-8 lg:px-12 sm:py-20">
          <ScrollReveal>
            <div className="narrative-panel rounded-3xl p-8 text-center sm:p-12">
              <p className="reading-subtitle text-3xl font-display text-lasa-700">
                {page.placeholder}
              </p>
              <p className="reading-copy mx-auto mt-4 text-lasa-600">{page.note}</p>
              <Link
                to={content.paths.home}
                className="mt-8 inline-flex items-center rounded-full border border-lasa-200 bg-white px-6 py-3 text-sm font-semibold uppercase tracking-widest text-lasa-600 transition hover:bg-lasa-50"
              >
                {page.back}
              </Link>
            </div>
